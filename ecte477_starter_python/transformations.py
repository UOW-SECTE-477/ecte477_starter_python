# From jarvisschultz https://answers.ros.org/question/332407/transformstamped-to-transformation-matrix-python/
...
def pq_to_se3(p, q):
    """Conversion from position and quaternion to 4x4 SE(3) transformation matrix
